...
class core_phpunit_advanced_testcase extends advanced_testcase {
    ...
    public function test_set_user() {
        ...
        $this->assertSame($_SESSIONPLN['USER'], $USER);
        ...
        $this->assertEquals(2, $_SESSIONPLN['USER']->id);
        $this->assertSame($_SESSIONPLN['USER'], $USER);
        $this->assertSame($GLOBALS['USER'], $USER);

        $USER->id = 3;
        $this->assertEquals(3, $USER->id);
        $this->assertEquals(3, $_SESSIONPLN['USER']->id);
        $this->assertSame($_SESSIONPLN['USER'], $USER);
        $this->assertSame($GLOBALS['USER'], $USER);
        ...
        $this->assertEquals(1, $_SESSIONPLN['USER']->id);
        $this->assertSame($_SESSIONPLN['USER'], $USER);
        $this->assertSame($GLOBALS['USER'], $USER);
